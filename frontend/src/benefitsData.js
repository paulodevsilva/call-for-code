const benefitsData = [
  {
    id: 1,
    title: 'MAIOR DISPONIBILIDADE DE ÁGUA',
    text: 'Aumento do volume de água nos rios, devido a recuperação das nascentes e matas ciliares.',
    path: './Icons/agua.png',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    text: 'Promoção da Responsabilidade Social.',
    path: './Icons/responsabilidade.png',
  },
  {
    id: 4,
